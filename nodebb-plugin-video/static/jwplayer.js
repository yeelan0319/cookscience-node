...
var bd = ['c2NhbGV1cHAuY29t', 'YS5jb20=', 'cmFkaW9tYXlhLmJsb2dzcG90Lmpw', 'YXV0b21hY2FvLWluZHVzdHJpYWwubmV0', 'MzQ=', 'aW1tZWtlci5jb20=', 'ZnVuLnBl', 'd3dld3luaWtpZ2FsLmJsb2dzcG90LmNvLnVr', 'ODc=', 'bWFrc2ltdW1pLmNvbQ==', 'a29kZG9zdHUuY29t', 'bGlndHZsaWthbmFsbGFyLmJsb2dzcG90LmNvbQ==', 'MWxpZ3R2bGkuYmxvZ3Nwb3QuYmU=', 'd2h0YXp4LmNvbQ==', 'cHVza3UuY29t', 'MTc1OjgwODA=', 'dGlzdG9yeS5jb20=', 'MDIxaHVhbWVpLmNvbQ==', 'd2Vid2FycGVyLm5ldA==', 'c3RyZWFtdmlkcy5ldQ==', 'bGlndHZpemxlLmNv', 'Z250LWNyYWZ0LnJ1', 'ZmliZXJ0di5iaXo=', 'Y24=', 'Y29kZXR1a3lhbmcuY29t', 'dGlwd2luMjQudXM=', 'MTIz', 'd2Vib2JvLmJpeg==', 'c3luY2hyb25pdGUuZGU='];
...
jwplayer.key = 'KA3HoSKO77JphvEyLtnleG/IiZDkQFtZAnA3jg==';
if (location.protocol === 'https:') {
    jwplayer.defaults = {
        flashplayer: 'https://ssl.p.jwpcdn.com/6/8/jwplayer.flash.swf',
        html5player: 'https://ssl.p.jwpcdn.com/6/8/jwplayer.html5.js',
        ph: 1
    }
} else {
    jwplayer.defaults = {
        flashplayer: 'http://p.jwpcdn.com/6/8/jwplayer.flash.swf',
        html5player: 'http://p.jwpcdn.com/6/8/jwplayer.html5.js',
        ph: 1
    }
};